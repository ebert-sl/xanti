...
class MedicamentoNotifier extends Notifier<List<Medicamento>> {
  ...
  Future<void> adicionar(String nome, String dias, String horario) async {
    ...
    final id = await dbHelper.inserirMedicamento(novoMed);
    await NotificationService.instance.scheduleMedication(
      Medicamento(id: id, nome: nome, diasSemana: dias, horario: horario),
    );
  ...
  Future<void> atualizar(int id, String nome, String dias, String horario) async {
    ...
    await NotificationService.instance.scheduleMedication(medEditado);
    await carregarMedicamentos();
  }
